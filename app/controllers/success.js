...
export default BaseController.extend({
  ...
  description: computed('message', function () {
    return {
      signup_confirmation_sent: 'To complete the sign-up process, please click the one-time link sent to your email address.',
      ...
      email_confirmation: 'Thanks for confirming your email address. Now you\'re ready to start your registration.',
